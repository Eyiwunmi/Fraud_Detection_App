...
# ============================================
# 1. Inline Feature Engineering Transformer
# ============================================
...
# ============================================
# 2. Load Pipeline + Threshold
# ============================================
pipeline, THRESHOLD = joblib.load("fraud_detection_pipeline.pkl")
...
if uploaded_file:
    ...
    # Apply pipeline (automated feature engineering included)
    preds_proba = pipeline.predict_proba(data)[:, 1]
    data["fraud_probability"] = preds_proba
    data["fraud_prediction"] = (preds_proba >= THRESHOLD).astype(int)
